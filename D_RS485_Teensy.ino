...
void setup()
{
  ...
  // RX4 default pin 16
  // TX4 default pin 17
  // Transmit Enable could be any pin. Without flow control not used
  #define HWSERIAL Serial4
  HWSERIAL.setRX(16); // Serial1: Pin 0 = RX1                 Serial4: Pin 16 = RX4
  HWSERIAL.setTX(17); // Serial1: Pin 1 = TX1                 Serial4: Pin 17 = TX4
